...
class FilterChipsRow extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final entries = [
      (NoteFilter.all, context.l10n.filter_all),
      (NoteFilter.reminders, context.l10n.filter_reminders),
      (NoteFilter.checklists, context.l10n.filter_checklists),
      (NoteFilter.images, context.l10n.filter_images),
    ];
    return SizedBox(
      height: 40,
